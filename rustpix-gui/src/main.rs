...
use rustpix_algorithms::{
    AbsClustering, DbscanClustering, GraphClustering, GridClustering, HitClustering,
};
...
impl RustpixApp {
    ...
    fn update_texture(&mut self) {
        ...
        let _image = egui::ColorImage::from_rgba_unmultiplied([bins, bins], &pixels);
    ...
    fn generate_histogram_image(&self) -> egui::ColorImage {
        ...
        egui::ColorImage::from_rgba_unmultiplied([bins, bins], &pixels)
    }
}
    ...
    fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
        egui::SidePanel::left("controls_panel").show(ctx, |ui| {
            ...
            ui.group(|ui| {
                ...
                ui.add(
                    egui::Slider::new(&mut self.min_cluster_size, 1..=10).text("Min Cluster Size"),
                );
                ...
                if ui
                    .add_enabled(
                        !self.is_processing && self.selected_file.is_some(),
            ...
            ui.group(|ui| {
                ...
                if !self.neutrons.is_empty() {
                    let mean_size = self.neutrons.iter().map(|n| n.n_hits as f64).sum::<f64>()
                        / self.neutrons.len() as f64;
