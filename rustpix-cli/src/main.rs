...
fn run_process_hdf5(
    ...
    // TDC rebase state: each TPX3 file has an independent TDC clock.
    // Normalise each file to its first-pulse baseline and then offset to
    // stay monotonically increasing across file boundaries.
