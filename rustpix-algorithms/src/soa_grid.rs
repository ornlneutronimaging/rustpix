...
impl Default for SoAGridClustering {
    fn default() -> Self {
...
mod tests {
    ...
    fn test_soa_clustering() {
        ...
        let algo = SoAGridClustering::default();
